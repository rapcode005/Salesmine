<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductSummaryT.aspx.cs"
    Inherits="WebSalesMine.WebPages.ProductSummary.ProductSummaryT" MasterPageFile="~/WebPages/UserControl/NewMasterPage.Master" %>
...
<asp:Content ID="T2" runat="server" ContentPlaceHolderID="container">
  <style type="text/css">
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td class="object-wrapper" style="height: 20px">
                                <asp:LinkButton ID="LinkFilterBy" runat="server" CssClass="LabelFont"
                                    Visible="false">Filter by: </asp:LinkButton>
                             ...
                             <%if (userRule != "PC-MAN" || userRule != "PC-ONT")
                                                    { %> 
                            <td class="object-wrapper" style="height: 20px">
                                <asp:LinkButton ID="btnExportToExcel" runat="server" CssClass="LabelFont"
                                    OnClick="btn_Export2ExcelClick">Export to Excel</asp:LinkButton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                            <% }%>
                            <%if (ArrnageColumnstring == "lvwSKUSummaryT")
                              { %>
                            <td class="object-wrapper" style="height: 20px">
                                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="LabelFont"
                                    OnClientClick="window.open('../Home/ArrangeColumns.aspx?Data=lvwSKUSummaryT','mywindow','width=700,height=400,scrollbars=yes')">Arrange Product Summary Columns</asp:LinkButton>
                            </td>
                            <% }%>
                            <%if (ArrnageColumnstring == "lvwPCSKUSummaryT")
                              { %>
                            <td class="object-wrapper" style="height: 20px">
                                <asp:LinkButton ID="LinkButton2" runat="server" CssClass="LabelFont"
                                    OnClientClick="window.open('../Home/ArrangeColumns.aspx?Data=lvwPCSKUSummaryT','mywindow','width=700,height=400,scrollbars=yes')">Arrange Product Summary Columns</asp:LinkButton>
                            </td>
                            <% }%>
                        </tr>
                    </table>
                                ...
                                <ContentTemplate>
                                    <asp:Panel runat="server" ScrollBars="None" ID="DataDiv" Style="width: 100%; height: 100%;">
                                        <asp:GridView ID="grdProductLineSummary" runat="server" AutoGenerateColumns="False"
                                            EmptyDataText="No data available." Width="100%" AllowPaging="false" CellPadding="4"
                                            ...
                                            OnPreRender="grdProductLineSummary_Prerender"
                                            ForeColor="Black"
                                            GridLines="None" AsyncRendering="false">
                                            ...
                                            <Columns>
                                                    ...
                                                    <ItemTemplate>
                                                        <div align="center">
                                                            <asp:LinkButton ID="lbtnShowSKU" runat="server" CommandName="ShowPLSKU" CommandArgument='<%# Eval("SKU CATEGORY")%>'
                                                                Text="Filter" PostBackUrl="~/WebPages/ProductSummary/ProductSummaryT.aspx" /></div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField HeaderText="PRODUCT LINE" DataField="SKU CATEGORY" SortExpression="SKU CATEGORY" />
                                                <asp:BoundField HeaderText="" DataField="F12 SALES" SortExpression="F12 SALES"
                                                    ItemStyle-HorizontalAlign="Right" DataFormatString="{0:##,#####}">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="" DataField="F13 SALES" SortExpression="F13 SALES"
                                                    ItemStyle-HorizontalAlign="Right" DataFormatString="{0:##,#####}">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="" DataField="F14 SALES" SortExpression="F14 SALES"
                                                    ItemStyle-HorizontalAlign="Right" DataFormatString="{0:##,#####}">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="" DataField="F15 SALES" SortExpression="F15 SALES"
                                                    ItemStyle-HorizontalAlign="Right" DataFormatString="{0:##,#####}">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField HeaderText="LAST ORDER DATE" DataField="LAST ORDER DATE" DataFormatString="{0:dd/MM/yyyy}"
                                                    SortExpression="LAST ORDER DATE" ItemStyle-HorizontalAlign="Right">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="" DataField="F12 UNITS" SortExpression="F12 UNITS"
                                                    ItemStyle-HorizontalAlign="Right" DataFormatString="{0:##,#####}">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="" DataField="F13 UNITS" SortExpression="F13 UNITS"
                                                    ItemStyle-HorizontalAlign="Right" DataFormatString="{0:##,#####}">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="" DataField="F14 UNITS" SortExpression="F14 UNITS"
                                                    ItemStyle-HorizontalAlign="Right" DataFormatString="{0:##,#####}">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="" DataField="F15 UNITS" SortExpression="F15 UNITS"
                                                    ItemStyle-HorizontalAlign="Right" DataFormatString="{0:##,#####}">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                            </Columns>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:Panel ID="pnlgrdSkuSummary" runat="server" ScrollBars="Auto" Style="width: 100%;
                                        height: 100%;">
                                        <asp:GridView ID="grdSkuSummary" runat="server" AutoGenerateColumns="false" Width="100%" ClientIDMode="Static"
                                            EmptyDataText="No data available." PageSize="10" AllowPaging="false" AllowSorting="true"
                                            CellPadding="4" CellSpacing="1" Font-Size="12px" ForeColor="Black" GridLines="None"
                                            BackColor="#FFFFFF" AsyncRendering="false" OnPageIndexChanging="grdSkuSummaryDataPageEventHandler"
                                            OnSorting="grdSkuSummary_Sorting" OnRowDataBound="grdSkuSummary_RowDataBound">
                                            <AlternatingRowStyle BackColor="#CCCCCC" />
                                            <EditRowStyle CssClass="EditRowStyle" />
                                            <HeaderStyle BackColor="#D6E0EC" Wrap="false" Height="30px" CssClass="HeaderStyle" />
                                            <RowStyle CssClass="RowStyle" Wrap="false" />
                        ...
                        <td align="left">
                            <asp:Panel ID="Panel5" runat="server" Width="100%">
                                <asp:GridView ID="grdPCProductLineSummary" runat="server" AutoGenerateColumns="false"
                                    ...
                                    OnRowDataBound="grdPCProductLineSummary_RowDataBound"
                                    OnRowCommand="grdPCProductLineSummary_RowCommand" AllowSorting="true" 
                                    OnSorting="grdProductLineSummary_Sorting"
                                    OnPageIndexChanging="grdPCProductLineSummaryDataPageEventHandler">
                                    <AlternatingRowStyle BackColor="#CCCCCC" />
                                    <EditRowStyle CssClass="EditRowStyle" />
                                    <HeaderStyle BackColor="#D6E0EC" Wrap="false" Height="30px" CssClass="HeaderStyle" />
                                    <RowStyle CssClass="RowStyle" Wrap="false" />
                    ...
                    <tr>
                        <td align="left">
                            <asp:Panel ID="Panel3" runat="server" Width="100%">
                                <asp:GridView ID="grdPCSKUSummary" runat="server" AutoGenerateColumns="True" Width="100%" ClientIDMode="Static"
                                    CellPadding="4" CellSpacing="1" Font-Size="12px" ForeColor="Black" GridLines="None"
                                    BackColor="#FFFFFF" AsyncRendering="false" EmptyDataText="No data available."
    ...
    <asp:Panel ID="pnlSKUSummary" runat="server" Style="display: none; " 
    ClientIDMode="Static">
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblSKUFamily" CssClass="LabelFont" runat="server" Text="SKU Family"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblSKUDesc" CssClass="LabelFont" runat="server" Text="SKU Description"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtSKUDesc" CssClass="textboxLabel" Style="font-size: 12px;  width:220px;" ReadOnly="true"
                        ClientIDMode="Static" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblSKUNumber" CssClass="LabelFont" runat="server" Text="SKU Number"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblFO9"  Width="100%" CssClass="LabelFont" runat="server" Text="F10 Sales"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblF10" CssClass="LabelFont" runat="server" Text="F11 Sales"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtF10" CssClass="textboxLabel" Style="font-size: 12px; width:220px;" ReadOnly="true"
                        ClientIDMode="Static" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblF11" CssClass="LabelFont" runat="server" Text="F12 Sales"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtF11" CssClass="textboxLabel" Style="font-size: 12px; width:220px;" ReadOnly="true"
                        ClientIDMode="Static" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblF12" CssClass="LabelFont" runat="server" Text="F13 Sales"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtlifetimesales" CssClass="textboxLabel" Style="font-size: 12px; width:220px;"
                        ReadOnly="true" ClientIDMode="Static" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtlifetimeorders" CssClass="textboxLabel" Style="font-size: 12px; width:220px;"
                        ReadOnly="true" ClientIDMode="Static" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtlastordereddate" CssClass="textboxLabel" Style="font-size: 12px; width:220px;"
                        ReadOnly="true" ClientIDMode="Static" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblf09units" CssClass="LabelFont" runat="server" Text="F10 Units"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblf10units" CssClass="LabelFont" runat="server" Text="F11 Units"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblf11units" CssClass="LabelFont" runat="server" Text="F12 Units"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblf12units" CssClass="LabelFont" runat="server" Text="F13 Units"></asp:Label>
                </td>
                <td>
