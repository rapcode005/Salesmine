...
$.Window = (function()  {
	...
	// the static setting
	var setting = {
		dock: 'right',                   // [string:"left"] the direction of minimized window dock at. the available values are [left, right, top, bottom]
	...
	function constructor(caller, options) {
		...
		var options = $.extend({
			...
			y: 200,                        // [number:-1] the y-axis value on screen(or caller element), if -1 means put on screen(or caller element) center
			z: 2000,                      // [number:2000] the css z-index value
			width: 850,                   // [number:400] window width
			height: 450,                  // [number:300] window height
			...
			maxWidth: 900,                // [number:800] the maximum width, if -1 means no checking
			maxHeight: 500,               // [number:600] the maximum height, if -1 means no checking
                ...
                if (found == 5) {
                    $.ajax({
                        ...
                        contentType: "application/json",
                                 data: "{var1:'NOFalse'}",
                        url: "../Home/SessionSetFromjquery.aspx/SaveValueInSession",
                        dataType: "json",
	...
	return { // static public methods
        ...
        getShriSelectedWindow: function() { // get the selected window instance
			return minimized;
		},
...
$.window.getShriSelectedWindow = $.Window.getShriSelectedWindow;