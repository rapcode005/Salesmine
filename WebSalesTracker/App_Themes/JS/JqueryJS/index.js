...
function createWindowWithRemotingUrl(KamWindowName) {
    ...
    if (t == 0) {
        ...
        $.window({
            title: "KAM Territories : " + KamWindowName,
            url: "../Home/KamWindow.aspx"
        });
...
function ArrangeColumnPage(vPagename) {
    var t = test1();
    ...
    if (t == 0) {
        ...
        $.window({
            ...
            url: "../Home/ArrangeColumns.aspx?Data=" + vPagename
